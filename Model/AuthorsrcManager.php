...
use N1c0\OfficialtextBundle\Event\AuthorsrcPersistEvent;
...
abstract class AuthorsrcManager implements AuthorsrcManagerInterface
{
    ...
    public function createAuthorsrc(OfficialtextInterface $officialtext)
    {
        ...
        $authorsrc->setOfficialtext($officialtext);
     ...
     * @throws InvalidAuthorsrcException when the authorsrc does not have a officialtext.
     */
